  ...
  return (
    ...
    "
        ...
        "
                      ...
                      {/* Pricing & CTA */}
                      <div className="md:w-48 flex flex-col justify-between items-center md:items-end gap-6 border-t md:border-t-0 md:border-l border-border/50 pt-6 md:pt-0 md:pl-8 relative">

...
const Freelancers = () => {
  ...
  const {
    ...
    isLoading,
    isFetching,
    freelancersPagination: pagination,
  } = useDashboard("admin", {
    page,
    limit: 10,
  ...
  if (isLoading && !freelancers.length) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
        <Loader2 className="h-10 w-10 animate-spin text-primary" />
        <p className="text-muted-foreground text-sm font-medium">
          Loading freelancers analytics...
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-8xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-xs sm:text-sm">
            Overview and manage all active registered talent profiles.
          </p>
        </div>
        ...
        {freelancers.length > 0 ? (
              ...
              <Table>
                <TableHeader className="bg-secondary/40">
                  <TableRow className="hover:bg-transparent border-border/50">
                    <TableHead className="py-5 px-6 font-bold">Freelancer</TableHead>
                ...
                <TableBody>
                  {freelancers.map((freelancer) => (
                    <TableRow key={freelancer.id} className="group border-border/40 hover:bg-primary/[0.01] transition-smooth">
          ...
          <div className="glass rounded-[2rem] py-16 text-center border border-border/40 shadow-soft">
            ...
            <h3 className="text-lg font-semibold text-foreground">No freelancers found</h3>
